...
## Gen 2 Rebuild & Validation

Redesigned and rebuilt the fuselage to address the failure:

![Gen 2 build](Gen%202%20buid.jpg)
*Gen 2 fuselage rebuild*

Rather than going straight back to flight, the fix was first validated on the ground across a range of throttle levels:

**Videos:**
- [50percent_throttle test.mp4](50percent_throttle%20test.mp4) — 50% throttle test
- [100percent throttle test.mp4](100percent%20throttle%20test.mp4) — 100% throttle test

![FPV Kit](FPV%20Kit.jpg)
*WalkSnail FPV kit*

## My Role

Independently handled the fuselage's 3D-printing design and build, avionics installation and setup, and flight testing. After the crash, independently carried out the failure analysis (linking torque to shear failure) and proposed the two-part fix: throttle-curve limiting plus localised infill reinforcement. Redesigned the Gen 2 fuselage and validated the fix through graduated ground throttle testing.
